...
import { FaUserShield, FaUsers, FaSearch, FaBan, FaCheck, FaTimes, FaEdit, FaStar, FaExclamationTriangle, FaBoxOpen, FaGift } from 'react-icons/fa';
...
import AdminRewardsConfig from '../components/AdminRewardsConfig';
    ...
    return (
        <div className="p-6 text-white max-w-6xl mx-auto animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                {/* Add more stats here */}
                <div className="bg-[#1e1f2b] p-6 rounded-xl border border-white/10 flex flex-col justify-between">
                    <h3 className="text-gray-400 text-sm font-bold uppercase">Recompensas Diárias</h3>
                    <button
                        onClick={() => setIsRewardsConfigOpen(true)}
                        className="mt-3 px-4 py-2.5 bg-purple-600 hover:bg-purple-500 text-white font-bold rounded-xl text-sm flex items-center gap-2 transition-colors"
                    >
                        <FaGift /> Configurar Recompensas
                    </button>
                </div>
            </div>
            ...
            <AdminRewardsConfig
                ...
                onClose={() => setIsRewardsConfigOpen(false)}
            />
        </div>
    );
};
