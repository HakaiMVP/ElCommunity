...
const Guides = () => {
    ...
    const fetchGuides = async () => {
        ...
        const { data: profilesData, error: profilesError } = await supabase
            .from('profiles')
            .select('*, equipped_frame, equipped_effect, equipped_avatar_decoration, equipped_profile_effect, equipped_name_color, equipped_card_background')
            .in('id', userIds);
                        ...
                        {filteredGuides.map((guide) => {
                            ...
                            return (
                                <div
                                    ...
                                    className={`bg-[#1e1f2b] rounded-2xl overflow-hidden border transition-all duration-300 cursor-pointer group flex flex-col h-[350px] relative ${guideCosmetics.cardBackground || 'border-white/5 hover:border-purple-500/50 hover:shadow-[0_0_20px_rgba(147,51,234,0.15)]'}`}
                                >
                                    {/* Thumbnail Area */}
                                    ...
                                    <div className="p-5 flex flex-col flex-1 relative overflow-hidden">
                                        ...
                                        <div className="relative z-10 flex flex-col h-full">
                                            <div className="flex items-center gap-2 mb-3 shrink-0">
                                                <div className={`w-6 h-6 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-[10px] font-bold overflow-hidden ${guideCosmetics.avatarBorder || ''}`}>
                                                ...
                                                <span className={`text-xs font-medium truncate max-w-[150px] ${guideCosmetics.nameColor || 'text-gray-400'}`}>
                                            ...
                                            <h3 className="text-lg font-bold text-white mb-2 line-clamp-2 leading-tight group-hover:text-purple-400 transition-colors shrink-0">
                                                {guide.title}
                                            </h3>
