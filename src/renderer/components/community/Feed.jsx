    ...
    const fetchPosts = async () => {
        ...
        try {
            const { data, error } = await supabase
                ...
                .select('*, profiles:community_posts_author_fkey(username, avatar_url, equipped_frame, equipped_effect, equipped_avatar_decoration, equipped_profile_effect, equipped_name_color, equipped_card_background)')
