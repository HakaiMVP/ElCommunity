...
const HomeFeed = () => {
    ...
    const fetchInitialData = async () => {
        ...
        try {
            ...
            const { data: feedData, error } = await supabase
                ...
                .select(`
                    *,
                    profiles:community_posts_author_fkey(username, avatar_url, equipped_frame, equipped_effect, equipped_avatar_decoration, equipped_profile_effect, equipped_name_color, equipped_card_background),
    ...
    const userCosmetics = getCosmeticsForUser(userProfile || {});

    return (
        <div className="max-w-4xl mx-auto pb-10">
            {/* Create Post Widget */}
            <div className={`border rounded-xl p-4 mb-8 shadow-xl relative overflow-hidden transition-all ${userCosmetics.cardBackground || 'bg-[#1e1f2b] border-white/10'}`}>
                {userCosmetics.profileEffect && (
                ...
                <div className="flex items-center gap-3 mb-4 border-b border-white/5 pb-3 relative z-10">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center relative overflow-hidden shrink-0 ${userCosmetics.avatarBorder || 'bg-gray-700'}`}>
                        {user?.user_metadata?.avatar_url ? (
                            ...
                            <div className="w-full h-full flex items-center justify-center font-bold text-white relative z-10">
